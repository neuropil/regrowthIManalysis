imtest = imread('Long Sample 5c-3.tif');
...
wholePolymask_b7 = poly2mask(PolyXC_b7,PolyYC_b7,dim1,dim2);

% Threshold entire image

% Get values for thresholded image
greenMeasure2_b7 = greenN;
greenMeasure2_b7(~wholePolymask_b7) = 0;
grArea_b7 = bwarea(greenMeasure2_b7);

pxGr_b7 = grArea_b7/allArea;

% Get values for thresholded image

redMeasure2_b7 = redN;
redMeasure2_b7(~wholePolymask_b7) = 0;
redArea_b7 = bwarea(redMeasure2_b7);

pxRd_b7 = redArea_b7/allArea;
